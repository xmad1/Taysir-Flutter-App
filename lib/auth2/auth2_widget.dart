  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          backgroundColor: Color(0xFF002BFC),
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: Text(
                              FFLocalizations.of(context).getText(
                                'tvms7t54' /* Filling out the form below. */,
                              ),
                              style: FlutterFlowTheme.of(context)
                                  .labelMedium
                                  .override(
                            ...
                            child: Padding(
                              ...
                              child: FFButtonWidget(
                                onPressed: () async {
                                  ...
                                  // جلب بيانات المستخدم المحدثة (بما في ذلك الدور) مباشرة بعد تسجيل الدخول
                                  final userRecord =
                                      await UserTable().querySingleRow(
                                    queryFn: (q) => q.eq('uid', currentUserUid),
                                  );

                                  final updatedUserRow = userRecord.isNotEmpty
                                      ? userRecord.first
                                      : null;
                                  final userRole =
                                      updatedUserRow?.role ?? 'unknown';

                                  // 1. التحقق من حالة التعليق
                                  if (updatedUserRow?.status == 'Suspende') {
                                    ScaffoldMessenger.of(context).showSnackBar(
                                      SnackBar(
                                        content: Text(
                                          'Your account is suspende',
                                          style: TextStyle(
                                            color: FlutterFlowTheme.of(context)
                                                .primaryText,
                                          ),
                                    ...
                                    // تسجيل الخروج ومسح التوجيه بعد إظهار الرسالة
                                    GoRouter.of(context).prepareAuthEvent();
                                  ...
                                  // 2. التحقق من الدور والتوجيه
                                    ...
                                    if (userRole == 'user') {
                                      ...
                                      context.pushNamedAuth(
                                          AdminDashbordWidget.routeName,
                                          context.mounted);
                                    } else if (userRole == 'vendor') {
                                      context.pushNamedAuth(
                                          VendorDashboardPageWidget.routeName,
                                          context.mounted);
                                    }
                                    // 3. حالة الخطأ (دور غير معروف)
                                    else {
