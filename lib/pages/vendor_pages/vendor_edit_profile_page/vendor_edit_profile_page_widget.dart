...
class VendorEditProfilePageWidget extends StatefulWidget {
  const VendorEditProfilePageWidget({super.key});

  static String routeName = 'VendorEditProfilePage';
  static String routePath = '/vendorEditProfilePage';

  @override
  State<VendorEditProfilePageWidget> createState() =>
                                  ...
                                  FlutterFlowIconButton(
                                    ...
                                    onPressed: () async {
                                      ...
                                      if (selectedMedia != null &&
                                        ...
                                        safeSetState(() => _model
                                                .isDataUploading_uploadVendorImage =
                                            true);
                                        ...
                                        try {
                                          ...
                                          _model.isDataUploading_uploadVendorImage =
                                              false;
                                        }
                                        if (selectedUploadedFiles.length ==
                                            ...
                                            downloadUrls.length ==
                                                selectedMedia.length) {
                                          safeSetState(() {
                                            _model.uploadedLocalFile_uploadVendorImage =
                                                selectedUploadedFiles.first;
                                            _model.uploadedFileUrl_uploadVendorImage =
                                                downloadUrls.first;
                                          });
                                        } else {
                                          safeSetState(() {});
                                      ...
                                      _model.newPhotoURL = _model
                                          .uploadedFileUrl_uploadVendorImage;
                                      safeSetState(() {});
                                      safeSetState(
